      ...
      <div className="md:border-r overflow-y-auto overflow-x-hidden h-full min-h-0">
        <div className="p-3 space-y-2">
          <div className="font-semibold flex items-center justify-between">
            <span>Messages</span>
            <button onClick={newSupportChat} className="text-xs px-2 py-1 rounded-md bg-orange-500 text-white hover:bg-orange-600">New Support</button>
          </div>
