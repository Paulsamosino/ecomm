...
import { ShoppingBag, Egg, User, Clock, Heart, Home, Star } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white pt-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 relative">
        ...
        <div className="grid grid-cols-2 sm:flex flex-wrap gap-2 mb-6">
          ...
          <button
            onClick={() => window.postMessage({ type: "OPEN_SUPPORT_CHAT" }, "*")}
            className="inline-flex items-center justify-center px-3 sm:px-4 py-2 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-sm hover:shadow-md hover:from-blue-600 hover:to-blue-700 transition-all duration-200 text-sm"
          >
            <svg className="h-4 w-4 mr-1.5 sm:mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
